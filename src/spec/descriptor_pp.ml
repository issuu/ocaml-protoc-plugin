...
let rec pp_enum_descriptor_proto_enum_reserved_range fmt (v:Descriptor_types.enum_descriptor_proto_enum_reserved_range) = 
  let pp_i fmt () =
    Format.pp_open_vbox fmt 1;
...
let rec pp_enum_descriptor_proto fmt (v:Descriptor_types.enum_descriptor_proto) = 
  let pp_i fmt () =
    ...
    Pbrt.Pp.pp_record_field "reserved_range" (Pbrt.Pp.pp_list pp_enum_descriptor_proto_enum_reserved_range) fmt v.Descriptor_types.reserved_range;
...
let rec pp_descriptor_proto_extension_range fmt (v:Descriptor_types.descriptor_proto_extension_range) = 
  let pp_i fmt () =
    ...
    Pbrt.Pp.pp_record_field "start" (Pbrt.Pp.pp_option Pbrt.Pp.pp_int) fmt v.Descriptor_types.start;
    Pbrt.Pp.pp_record_field "end_" (Pbrt.Pp.pp_option Pbrt.Pp.pp_int) fmt v.Descriptor_types.end_;
    Pbrt.Pp.pp_record_field "options" (Pbrt.Pp.pp_option pp_extension_range_options) fmt v.Descriptor_types.options;
    Format.pp_close_box fmt ()
  in
  Pbrt.Pp.pp_brk pp_i fmt ()
...
let rec pp_method_options_idempotency_level fmt (v:Descriptor_types.method_options_idempotency_level) =
  match v with
...
let rec pp_method_options fmt (v:Descriptor_types.method_options) = 
  let pp_i fmt () =
    Format.pp_open_vbox fmt 1;
    Pbrt.Pp.pp_record_field "deprecated" (Pbrt.Pp.pp_option Pbrt.Pp.pp_bool) fmt v.Descriptor_types.deprecated;
    Pbrt.Pp.pp_record_field "idempotency_level" (Pbrt.Pp.pp_option pp_method_options_idempotency_level) fmt v.Descriptor_types.idempotency_level;
    Pbrt.Pp.pp_record_field "uninterpreted_option" (Pbrt.Pp.pp_list pp_uninterpreted_option) fmt v.Descriptor_types.uninterpreted_option;
    Format.pp_close_box fmt ()
  in
  Pbrt.Pp.pp_brk pp_i fmt ()
...
let rec pp_file_options fmt (v:Descriptor_types.file_options) = 
  let pp_i fmt () =
    ...
    Pbrt.Pp.pp_record_field "php_generic_services" (Pbrt.Pp.pp_option Pbrt.Pp.pp_bool) fmt v.Descriptor_types.php_generic_services;
    Pbrt.Pp.pp_record_field "deprecated" (Pbrt.Pp.pp_option Pbrt.Pp.pp_bool) fmt v.Descriptor_types.deprecated;
    ...
    Pbrt.Pp.pp_record_field "swift_prefix" (Pbrt.Pp.pp_option Pbrt.Pp.pp_string) fmt v.Descriptor_types.swift_prefix;
    Pbrt.Pp.pp_record_field "php_class_prefix" (Pbrt.Pp.pp_option Pbrt.Pp.pp_string) fmt v.Descriptor_types.php_class_prefix;
    Pbrt.Pp.pp_record_field "php_namespace" (Pbrt.Pp.pp_option Pbrt.Pp.pp_string) fmt v.Descriptor_types.php_namespace;
    Pbrt.Pp.pp_record_field "php_metadata_namespace" (Pbrt.Pp.pp_option Pbrt.Pp.pp_string) fmt v.Descriptor_types.php_metadata_namespace;
    Pbrt.Pp.pp_record_field "ruby_package" (Pbrt.Pp.pp_option Pbrt.Pp.pp_string) fmt v.Descriptor_types.ruby_package;
    Pbrt.Pp.pp_record_field "uninterpreted_option" (Pbrt.Pp.pp_list pp_uninterpreted_option) fmt v.Descriptor_types.uninterpreted_option;
    Format.pp_close_box fmt ()
  in
  Pbrt.Pp.pp_brk pp_i fmt ()
