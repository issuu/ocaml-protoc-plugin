...
let rec pp_version fmt (v:Plugin_types.version) = 
  let pp_i fmt () =
    ...
    Pbrt.Pp.pp_record_field "major" (Pbrt.Pp.pp_option Pbrt.Pp.pp_int) fmt v.Plugin_types.major;
    Pbrt.Pp.pp_record_field "minor" (Pbrt.Pp.pp_option Pbrt.Pp.pp_int) fmt v.Plugin_types.minor;
    Pbrt.Pp.pp_record_field "patch" (Pbrt.Pp.pp_option Pbrt.Pp.pp_int) fmt v.Plugin_types.patch;
    Pbrt.Pp.pp_record_field "suffix" (Pbrt.Pp.pp_option Pbrt.Pp.pp_string) fmt v.Plugin_types.suffix;
...
let rec pp_code_generator_request fmt (v:Plugin_types.code_generator_request) = 
  let pp_i fmt () =
    ...
    Pbrt.Pp.pp_record_field "compiler_version" (Pbrt.Pp.pp_option pp_version) fmt v.Plugin_types.compiler_version;
    Format.pp_close_box fmt ()
  in
  Pbrt.Pp.pp_brk pp_i fmt ()
